...
import {
  ...
  type getSkjoldenMonthSummaries,
} from "@/lib/skjolden-schedules";

type MonthSummary = ReturnType<typeof getSkjoldenMonthSummaries>[number];
  ...
  return (
    <div className="space-y-10">
      ...
      <p className="text-sm leading-6 text-slate-500">
        ...
        {skjoldenScheduleIntegrity.lastDate
