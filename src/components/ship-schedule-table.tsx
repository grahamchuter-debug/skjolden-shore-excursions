...
function compareValues(
  a: SkjoldenScheduleEntry,
  b: SkjoldenScheduleEntry,
  key: SortKey,
): number {
    ...
    <div className="space-y-4">
      <label className="block">
        ...
        <input
          ...
          aria-label="Search Skjolden ship schedule"
