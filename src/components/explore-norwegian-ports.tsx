...
export const explorePortsFromSkjolden: ExploreNorwegianPortsConfig = {
  intro: (
    <>
      If your itinerary includes more than one Norwegian port, plan each call
      around your ship&apos;s timetable before you sail. Many Sognefjord cruises
      pair Skjolden with{" "}
      <a
      ...
      ,{" "}
      <a
        href="https://nordfjordeidshoreexcursions.com"
        className="font-medium text-[var(--norway-blue)] underline-offset-2 hover:underline"
      >
        Nordfjordeid Shore Excursions
      </a>
      , and{" "}
      <a
        href="https://trondheimshoreexcursions.com"
        className="font-medium text-[var(--norway-blue)] underline-offset-2 hover:underline"
      >
  ...
  cards: [
    ...
    },
    {
      ...
      description:
        "Compare Honningsvag North Cape tours, Arctic excursions, port guides, and cruise planning tools.",
    ...
    },
    {
      ...
      description:
        "Compare Kristiansand harbour walks, southern Norway tours, port guides, and cruise planning tools.",
    ...
    },
    {
      ...
      description:
        "Compare Hellesylt Mount Stranda tours, Briksdal Glacier routes, port guides, and cruise planning tools.",
    ...
    {
      title: "Nordfjordeid Shore Excursions",
      titleHref: "https://nordfjordeidshoreexcursions.com",
      description:
        "Compare Nordfjordeid Viking heritage tours, Briksdal Glacier routes, port guides, and cruise planning tools.",
      ctaLabel: "Visit Nordfjordeid Shore Excursions",
      ctaHref: "https://nordfjordeidshoreexcursions.com",
      image: siteImages.nordfjordeidPortCard,
      imageAlt: imageAlts.nordfjordeidPortCard,
    },
    {
      title: "Trondheim Shore Excursions",
      titleHref: "https://trondheimshoreexcursions.com",
      description:
        "Compare Trondheim Nidaros Cathedral tours, harbour walks, port guides, and cruise planning tools.",
      ctaLabel: "Visit Trondheim Shore Excursions",
      ctaHref: "https://trondheimshoreexcursions.com",
      image: siteImages.trondheimPortCard,
      imageAlt: imageAlts.trondheimPortCard,
    },
  ],
};
